...
const GexFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_gex_free(ptr >>> 0, 1));
/**
...
export class Gex {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        GexFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_gex_free(ptr, 0);
    }
}
...
export class GrandEx {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(GrandEx.prototype);
        obj.__wbg_ptr = ptr;
        GrandExFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        GrandExFinalization.unregister(this);
        return ptr;
    }
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('grand_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
